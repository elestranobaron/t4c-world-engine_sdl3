...
VSFInterface::read_sprite(struct _sprite *spr, bool creer_miroir)
{
  ...
  spr->sdl_sprite = TnC_CreateIndexedSurfaceFrom(spr->pixels, spr->largeur, spr->hauteur, spr->largeur);
  TnC_SetPalette(spr->sdl_sprite, spr->palette->rgb, 0, 256);
  TnC_SetColorKeyIndex(spr->sdl_sprite, spr->transparence);
  spr->sdl_sprite = TnC_BakeIndexedSprite(spr->sdl_sprite);
  ...
  if (creer_miroir)
  {
    ...
    spr->sdl_sprite_miroir = TnC_CreateIndexedSurfaceFrom(spr->pixels_miroir, spr->largeur, spr->hauteur, spr->largeur);
    TnC_SetPalette(spr->sdl_sprite_miroir, spr->palette->rgb, 0, 256);
    TnC_SetColorKeyIndex(spr->sdl_sprite_miroir, spr->transparence);
    spr->sdl_sprite_miroir = TnC_BakeIndexedSprite(spr->sdl_sprite_miroir);
  }
